...
function doAdd() {
	...
	res += "<div class='center-block' id='show_table'><h1 class='text-center'>二年二班刘墨瞳口算作业</h1><h3 class='text-center'>日期（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）正确（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）时间（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）</h3><table class='table table-responsive'>";
			...
			if(if_num < if_next) {
				...
				if(x - y - z <= zmax && x - y - z >= zmin) {
					if(y < 0 && z > 0) {
						...
						res += i + "、" + x +"-"+ y + "-" + z + "="+"<br><br><br><br><br><br><br><br>";
						i++;
					} else if(y > 0 && z < 0) {
						res += i + "、" + x + "+" + y + z + "=";
						i++;
